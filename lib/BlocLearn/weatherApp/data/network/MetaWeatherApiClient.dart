...
class MetaWeatherApiClient {
  ...
  Future<WeatherResponse> locationSearch(String query) async {
    ...
    return WeatherResponse.fromJson(locationJson.first as Map<String, dynamic>);
  }

  /// Fetches [Weather] for a given [locationId].
  Future<LocationResponse> getWeather(int locationId) async {
    ...
    return LocationResponse.fromJson(weatherJson.first as Map<String, dynamic>);
  }
}
